...
function Import(){
    ...
    return(
        <>
        <button style={{width:"180px"}}  class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Import
        </button>
    ...
    <div class="modal-content">
      ...
      Drag and Drop CSV file In Brown Area to upload
            ...
            onDrop={(e)=>{
                ...
                axios({
                    url: "https://contact-manager-backened.onrender.com/contact/add",
                    method: "POST",
                    headers: {
